...
INSTALLED_APPS = [
    ...
    'django.contrib.messages', 'django.contrib.staticfiles', 'django_vite',
    'basic.apps.BasicConfig', 'posts.apps.PostsConfig',
    'users.apps.UsersConfig', 'community.apps.CommunityConfig'
]
